...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47_ngx_perfect_scrollbar__ = __webpack_require__("../../../../ngx-perfect-scrollbar/dist/index.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_47_ngx_perfect_scrollbar___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_47_ngx_perfect_scrollbar__);
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_47_ngx_perfect_scrollbar__["PerfectScrollbarModule"].forRoot(PERFECT_SCROLLBAR_CONFIG),
...
var BuilderSubFiveComponent = (function () {
    ...
    BuilderSubFiveComponent.prototype.deleteSubmenu = function (id, menuId) {
        var _this = this;
        ...
        this.menuService.deleteMenuFromServer(menuId).subscribe(function (res) {
            if (menuId === _this.top_menu_id) {
                _this.fileModel = null;
            }
            ...
            /*if (this.subMenuRes.menu.length > 0) {
             if (this.subMenuRes.menu)
             }*/
        });
    };
    BuilderSubFiveComponent.prototype.deleteSubmenu2 = function (index, menuId) {
        var _this = this;
        console.log('passed array id DELETE == ' + index + ' Menu id == ' + menuId);
        this.menuService.deleteSubmenu2FromServer(menuId).subscribe(function (res) {
            if (index === _this.top_menu_id) {
                _this.fileModel = null;
            }
            _this.subMenuRes.menu.splice(index, 1);
        });
    };
...
var BuilderSubFourComponent = (function () {
    ...
    BuilderSubFourComponent.prototype.deleteSubmenu = function (id, menuId) {
        var _this = this;
        console.log('passed array id DELETE == ' + id + ' Menu id == ' + menuId);
        // this.listItems.splice(id, 1);
        this.menuService.deleteMenuFromServer(menuId).subscribe(function (res) {
    ...
    BuilderSubFourComponent.prototype.deleteSubmenu2 = function (index, menuId) {
        var _this = this;
        console.log('passed array id DELETE == ' + index + ' Menu id == ' + menuId);
        this.menuService.deleteSubmenu2FromServer(menuId).subscribe(function (res) {
            if (index === _this.top_menu_id) {
...
var BuilderSubOneComponent = (function () {
    ...
    BuilderSubOneComponent.prototype.deleteSubmenu2 = function (index, menuId) {
        var _this = this;
        console.log('passed array id DELETE == ' + index + ' Menu id == ' + menuId);
        this.menuService.deleteSubmenu2FromServer(menuId).subscribe(function (res) {
            if (index === _this.top_menu_id) {
...
var BuilderSubThreeComponent = (function () {
    ...
    BuilderSubThreeComponent.prototype.deleteSubmenu = function (id, menuId) {
        var _this = this;
        console.log('passed array id DELETE == ' + id + ' Menu id == ' + menuId);
        // this.listItems.splice(id, 1);
        this.menuService.deleteMenuFromServer(menuId).subscribe(function (res) {
    ...
    BuilderSubThreeComponent.prototype.deleteSubmenu2 = function (index, menuId) {
        var _this = this;
        console.log('passed array id DELETE == ' + index + ' Menu id == ' + menuId);
        this.menuService.deleteSubmenu2FromServer(menuId).subscribe(function (res) {
            if (index === _this.top_menu_id) {
...
var BuilderSubTwoComponent = (function () {
    ...
    BuilderSubTwoComponent.prototype.deleteSubmenu = function (id, menuId) {
        var _this = this;
        console.log('passed array id DELETE == ' + id + ' Menu id == ' + menuId);
        // this.listItems.splice(id, 1);
        this.menuService.deleteMenuFromServer(menuId).subscribe(function (res) {
    ...
    BuilderSubTwoComponent.prototype.deleteSubmenu2 = function (index, menuId) {
        var _this = this;
        console.log('passed array id DELETE == ' + index + ' Menu id == ' + menuId);
        this.menuService.deleteSubmenu2FromServer(menuId).subscribe(function (res) {
            if (index === _this.top_menu_id) {
...
exports = module.exports = __webpack_require__("../../../../css-loader/lib/css-base.js")(false);
// imports
exports.i(__webpack_require__("../../../../css-loader/index.js?{\"sourceMap\":false,\"importLoaders\":1}!../../../../postcss-loader/index.js?{\"ident\":\"postcss\"}!../../../../../src/assets/css/perfect-scrollbar.css"), "");
...
var AppSplashComponent = (function () {
    ...
    AppSplashComponent.prototype.buildApp = function () {
        ...
        this.busy = this.ais.buildMyApp(this.appModel).subscribe(function (res) {
            // this.appId = res.appid;
            console.log('Response on communicating with Jenkins == ' + JSON.stringify(res));
            _this.returnHome();
        }, function (err) {
            _this.notify.showError(err, 'An Error Occured, please try again', _this.vRef);
        });
    };
...
var MenuService = (function () {
    ...
    MenuService.prototype.deleteSubmenu2FromServer = function (id) {
        return this.http.delete(__WEBPACK_IMPORTED_MODULE_9__AppSettings__["a" /* AppSettings */].API_ENDPOINT + '/submenu2/' + id) // ...using put request
            .map(function (res) { return res.json(); }) //
            .catch(function (error) { return __WEBPACK_IMPORTED_MODULE_4_rxjs_Observable__["Observable"].throw(error.json().error || 'Server error'); });
    };
...
/***/ "../../../../css-loader/index.js?{\"sourceMap\":false,\"importLoaders\":1}!../../../../postcss-loader/index.js?{\"ident\":\"postcss\"}!../../../../../src/assets/css/perfect-scrollbar.css":
/***/ (function(module, exports, __webpack_require__) {
